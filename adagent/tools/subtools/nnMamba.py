...
class MambaLayer(nn.Module):
    def __init__(self, dim, d_state=16, d_conv=4, expand=2, bimamba='v2'):
        super().__init__()
        self.dim = dim
        ...
        self.mamba = Mamba(
            ...
            expand=expand,
            bimamba_type='v2'  # Block expansion factor
        )
...
class nnMambaEncoder(nn.Module):
    def __init__(self, in_ch=2, channels=32, blocks=3, number_classes=3):
